...
Your file stays in the browser. Extracted text can be sent to the SEAL server and, when configured, to Groq for claim structuring. The server does not store files or extracted claims. There is no database, account, or content analytics. Live-source checks fetch fixed allowlists of official Riverside and District of Connecticut pages; they never fetch a URL printed on a notice.
...
Tests use saved court excerpts and avoid live dependencies. The browser upload test includes a public [sample summons from the United States District Court for the District of Connecticut](https://coop.ctd.uscourts.gov/sites/default/files/Sample%20Jury%20Summons%20Form.pdf). Its fictional recipient and sample designation make it suitable for a repeatable upload regression. SEAL identifies the Hartford courthouse, court name, and jury status phone against separate [court location](https://www.ctd.uscourts.gov/content/hartford), [jury contact](https://www.ctd.uscourts.gov/contact-parking-information), and [FAQ](https://www.ctd.uscourts.gov/jury-info/jury-faqs) pages. It leaves private juror and 2017 reporting details unverified and provides the independently published number for jury questions. These matches do **not** authenticate the sample or any individual summons. The 14-case benchmark includes the genuine unmodified PDF and a single-field altered copy, alongside fictional fixtures and one generated degraded-photo OCR case; it is not a measurement on genuine summons photos. Live checks can fail or change; when they fail, results abstain and the court contact uses a clearly labeled, dated official snapshot. CourtListener is an index, so no result never means contradiction. Riverside official pages currently disagree about the Desert Region jury number, and SEAL shows both, with their check dates, rather than choosing one. The 2026 payment warning expressly addresses calls and texts; paper payment demands without matching direct evidence remain unverified.
