...
export async function verifyClaims(claims:Claim[],courtName:string,mode:'LIVE'|'SNAPSHOT'):Promise<Verification>{
 const r=RiversideSuperiorCourtResolver.supportedCourt(courtName)?RiversideSuperiorCourtResolver:FederalCourtListenerResolver.supportedCourt(courtName)?FederalCourtListenerResolver:UnsupportedCourtResolver;
